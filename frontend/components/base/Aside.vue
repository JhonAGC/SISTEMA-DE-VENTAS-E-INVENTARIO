<template lang="">
  <aside
    class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 h-screen overflow-auto flex-col"
    id="sidenav-main"
  >
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="/">
        <span class="ms-1 font-weight-bold">LA CASA DE MICAS</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="clientes">
            <ul class="nav ms-4 ps-3">
              <li class="nav-item">
                <nuxtLink class="nav-link" to="/cliente">
                  <span class="sidenav-mini-icon"> C </span>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="proveedors">
            <ul class="nav ms-4 ps-3">
              <li class="nav-item">
                <nuxtLink class="nav-link" to="/proveedor">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="caja">
            <ul class="nav ms-4 ps-3">
              <li class="nav-item">
                <nuxtLink class="nav-link" to="/cajas">
                  <span class="sidenav-mini-icon"> M </span>
                  <span class="sidenav-normal"> Mi Caja </span>
                </nuxtLink>
              </li>
              <li class="nav-item">
                <nuxtLink class="nav-link" to="/cajas/historial">
