                  ...
                  <div class="card-body d-flex p-3">
                    ...
                    <div class="dropdown pt-2">
                      ...
                      >
                        ...
                        <li v-for="m in categorias" :key="m.id">
                          <a
                            class="dropdown-item border-radius-md"
                            href="javascript:;"
              ...
              <div class="card-body text-center p-3">
                ...
                <div class="table-responsive p-0" style="min-height: 30vh">
                  ...
                  >
                    ...
                    <tbody>
                      <tr v-for="(m, i) in carrito" :key="m.id">
                        <td class="text-start">
  ...
  methods: {
    ...
    async Save() {
      ...
      if (this.carrito.length === 0) {
        this.$swal.fire({
          title: "Error",
          text: "Por favor, seleccione un producto antes de guardar.",
      ...
      // Validación para asegurar que un proveedor está seleccionado
      if (this.proveedor === "all") {
        this.$swal.fire({
          title: "Error",
          text: "Por favor, seleccione un proveedor antes de guardar.",
          showDenyButton: false,
          showCancelButton: false,
          confirmButtonText: "Ok",
        });
