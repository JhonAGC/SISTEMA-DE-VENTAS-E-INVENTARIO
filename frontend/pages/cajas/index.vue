                  ...
                  <div class="card-body px-3 pt-0 pb-2">
                    <div class="table-responsive p-0">
                      ...
                      >
                        ...
                        <tbody>
                          <tr v-for="(m, i) in caja.movimientos" :key="m.id">
                            <td>
                            ...
                            <td>
                              ...
                              <p
                                v-else
                                class="text-sm text-danger font-weight-bold mb-0"
                              >
                                -{{ m.monto }}
                              </p>
                            </td>
              ...
              >
                <div class="z-index-1 position-relative">
                  <h1 class="text-white mt-2 mb-0">
                    <small></small>{{ Number(caja.total).toFixed(2) }}
                  </h1>
                  ...
                  >
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <span class="text-xs">{{
                          Number(caja.ingresos).toFixed(2)
                        }}</span>
                      </div>
                    </div>
                    <div class="d-flex">
...
export default {
  ...
  methods: {
    ...
    async AddMovimiento() {
      ...
      await Promise.all([this.GET_DATA("cajas/" + this.user.caja_id)]).then(
        (v) => {
          this.caja = v[0];
        }
      );
