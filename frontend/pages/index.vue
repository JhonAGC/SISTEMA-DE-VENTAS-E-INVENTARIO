                ...
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder mb-0">
                        S/ {{ Number(dashboard.compras).toFixed(2) }}
                      </h5>
                    </div>
                  </div>
                  <div class="col-4 text-end">
                ...
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder mb-0">
                        S/ {{ Number(dashboard.ventas).toFixed(2) }}
                      </h5>
                    </div>
                  </div>
                  <div class="col-4 text-end">
          ...
          <div class="col-lg-5 mb-lg-0 mb-4">
            <div class="card z-index-2">
              <div class="card-body p-3">
                ...
                <h6 class="ms-2 mt-4 mb-0">Reportes</h6>
          ...
          <div class="col-lg-7">
            <div class="card z-index-2">
              <div class="card-header pb-0">
                <h6>Compras y Ventas por meses</h6>
                <!-- <p class="text-sm">
    ...
    this.$nextTick(() => {
      ...
      this.$nextTick(async () => {
        ...
        try {
              ...
              datasets: [
                {
                  ...
                  backgroundColor: "#fff",
                  data:
                    /* self.dashboard.meses[0].total,
                    self.dashboard.meses[1].total,
                    self.dashboard.meses[2].total, */
                    self.dashboard.meses.map((m) => m.total),
          ...
          gradientStroke1.addColorStop(1, "rgba(0, 255, 145, 0.8)");
            ...
            data: {
              ...
              datasets: [
                ...
                },
                {
                  ...
                  backgroundColor: gradientStroke1,
                  fill: true,
                  data: self.dashboard.mesesCompra.map((m) => m.totalCompras),
                  maxBarThickness: 6,
                },
              ],
            },
